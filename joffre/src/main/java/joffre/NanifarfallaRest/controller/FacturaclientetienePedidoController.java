...
public class FacturaclientetienePedidoController {
	...
	public Factura_ctienepedido createFacturaclientetienePedido(@Valid @RequestBody Factura_ctienepedido facturaclientetienepedido) {
		LOGGER.info("INFO TRACE");
		LOGGER.warn("WARNING  TRACE");
		LOGGER.error("ERROR TRACE");
		LOGGER.debug("DEBUG  TRACE");
	...
	public Factura_ctienepedido getFacturaclientetienePedidoById(@PathVariable(value = "id") int facturaclientetieneId) {
		LOGGER.info("INFO  TRACE");
		LOGGER.warn("WARNING  TRACE");
		LOGGER.error("ERROR TRACE");
		LOGGER.debug("DEBUG  TRACE");
	...
	public Factura_ctienepedido updateFacturaclientetienePedido(@PathVariable(value = "id") int facturaclientetieneId,
		...
		facturaclientetienepedido.setNombre_factura_cliente_tiene_pedido(facturaClientetienePedidoDetails.getNombre_factura_cliente_tiene_pedido());
		facturaclientetienepedido.setCliente_tiene_pedido(facturaClientetienePedidoDetails.getCliente_tiene_pedido());
		facturaclientetienepedido.setCodigo_factura_cliente_tiene_pedido(facturaClientetienePedidoDetails.getCodigo_factura_cliente_tiene_pedido());
		
		facturaclientetienepedido.setClaveApi(facturaClientetienePedidoDetails.getClaveApi());
		Factura_ctienepedido updatedFacturaclientetienePedido = factura_ctienepedidorepository.save(facturaclientetienepedido);
